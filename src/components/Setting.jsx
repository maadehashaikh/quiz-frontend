...
const Setting = () => {
  ...
  return (
    <div className="relative">
      ...
      <button
        className={`fixed top-6 left-6 md:hidden p-3 rounded-md z-50 transition-all duration-300
      ...
      {/* Sidebar Menu */}
      <div
        className={`fixed inset-y-0 left-0 w-64 md:w-72 lg:w-[300px] xl:w-[350px] h-screen bg-gray-100 shadow-lg transition-transform duration-300 z-20 
           ${
